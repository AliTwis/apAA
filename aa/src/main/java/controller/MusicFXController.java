...
public class MusicFXController {
    ...
    public void back(ActionEvent actionEvent) {
        ...
        else if (creepy.isSelected())
            LoginMenu.setMusic(LoginMenu.class.getResource("/sound/creepy.mp3").toExternalForm());
        else if (ofeliadream.isSelected())
            LoginMenu.setMusic(LoginMenu.class.getResource("/sound/ofeliasdream.mp3").toExternalForm());
        else if (slowmotion.isSelected())
            LoginMenu.setMusic(LoginMenu.class.getResource("/sound/slowmotion.mp3").toExternalForm());
        else if (november.isSelected())
            LoginMenu.setMusic(LoginMenu.class.getResource("/sound/november.mp3").toExternalForm());
        else if (scifi.isSelected())
            LoginMenu.setMusic(LoginMenu.class.getResource("/sound/scifi.mp3").toExternalForm());
